...
//Бележка: Скрипта, ще приеме и отрицателни стойности на числа. Което от гледна точка на кода е така, но от гледна точка
// на логиката, не е ОК. Трябва да се сложи 'нещо' което да ограничи тази опция!